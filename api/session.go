...
type Session struct {
	...
	RxBitrate float64 `json:"bandwidth_rx_kbit"`
	TxBitrate float64 `json:"bandwidth_tx_kbit"`
}
...
type SessionSummaryActive struct {
	...
	RxBitrate    float64   `json:"bandwidth_rx_mbit"`
	TxBitrate    float64   `json:"bandwidth_tx_mbit"`
	MaxRxBitrate float64   `json:"max_bandwidth_rx_mbit"`
	MaxTxBitrate float64   `json:"max_bandwidth_tx_mbit"`
}
